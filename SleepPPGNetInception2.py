...
class SleepPPGNetInception2(nn.Module):
    def __init__(self):
        super(SleepPPGNetInception2, self).__init__()
        ...
        self.inception_block1 = InceptionBlock(128, 128)
        self.inception_block2 = InceptionBlock(128, 128)
